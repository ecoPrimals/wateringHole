...
**Purpose**: How to integrate with `gardens/projectFOUNDATION` — the scientific
...
`gardens/projectFOUNDATION` is the soil. It declares:
...
| What | Where |
|------|-------|
| Data source manifests | `gardens/projectFOUNDATION/data/sources/*.toml` |
| Validation targets | `gardens/projectFOUNDATION/data/targets/*.toml` |
| Thread index | `gardens/projectFOUNDATION/lineage/THREAD_INDEX.toml` |
| baseCamp paper map | `gardens/projectFOUNDATION/lineage/BASECAMP_PAPER_MAP.toml` |
| Deploy graph | `gardens/projectFOUNDATION/graphs/foundation_validation.toml` |
| Fetch script | `gardens/projectFOUNDATION/deploy/fetch_sources.sh` |
| Validation pipeline | `gardens/projectFOUNDATION/deploy/foundation_validate.sh` |
| Workloads | `gardens/projectFOUNDATION/workloads/thread*_*/` |
| Data integrity spec | `gardens/projectFOUNDATION/specs/DATA_INTEGRITY_CONTRACT.md` |
| Expression authoring | `gardens/projectFOUNDATION/specs/EXPRESSION_AUTHORING_GUIDE.md` |
