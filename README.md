...
| **BarraCuda** | Pure Math | 826 WGSL f64 shaders (the mathematics), naga-IR optimisation (FMA fusion, DCE), precision strategy (f64/DF64/f32). Writes the math; coralReef compiles it; toadStool runs it. Budded from ToadStool (S93). v0.3.12, 4,368+ tests, 32 IPC methods, BTSP Phase 2 | Production (A+) |
