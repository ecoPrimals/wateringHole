...
- `fossilRecord/UPSTREAM_GAP_STATUS_APR20_2026.md` — Upstream gap tracker (biomeOS v3.35 absorbed, April 30)
...
### Handoffs
- `handoffs/*.md` — 32 active session handoffs (April 26 – May 2, 2026)
