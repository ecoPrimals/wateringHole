...
### Layer 2 — coralReef: Phase 10 Iteration 20, 9 Unsafe Remaining
...
1142 tests, 63% coverage. 47 cross-spring WGSL shaders (40 compiling SM70). tarpc uses bincode for binary IPC.
