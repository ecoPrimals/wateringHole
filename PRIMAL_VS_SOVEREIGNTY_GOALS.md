...
**Total**: 427 methods across 13 primals. Zero open upstream gaps.
8/8 springs at zero debt, 13,750+ tests.

### What "Shipped" Means at Layer 1

A primal capability is shipped when:
- The method exists in the registry (427 canonical)
...
|-------------|-------|--------|
| All 13 primal capabilities shipped | L1 | DONE (427 methods) |
