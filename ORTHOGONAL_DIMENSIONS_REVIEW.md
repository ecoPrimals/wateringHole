...
- **sporeGate: CI + MEMBRANE + SOLE BUILDER.** **DEPOT VERTEBRATE Aug 9** (8 primals rebuilt from vertebrate HEAD). **15/15 ALIVE**, 13,910 caps. blueGate now primary Windows build workhorse. Vine-bat operational. songBird mesh 11 peers. FD exhaustion fixed (LimitNOFILE=65536). nestgate.io 10/12. **biomeOS P0-C fix (`6a51638d`) needs next depot rebuild.**
