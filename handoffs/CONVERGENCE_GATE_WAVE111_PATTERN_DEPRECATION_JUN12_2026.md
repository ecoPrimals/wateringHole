...
**Status**: WATCHING — Criterion 4+8 GREEN, Criterion 1 partial (ironGate deployed, others pending VPS rebuild + cascade), 5 pending operational
...
|---|-----------|-----------|-------|-----------|
| 1 | **All gates run post-34e472d membrane** | `membrane --version` ≥ Wave 111 (riboCipher mito-tier) on all 5 active gates | ⚠️ PARTIAL | ironGate DEPLOYED (systemd, 13/13). eastGate/southGate pending VPS rebuild + cascade. |
