...
wetSpring has completed **91 experiments, 2,097+ validation checks, 728 Rust
tests, and 81 binaries** — all passing. The evolution path from Python baseline
...
|----------|--------|--------|
| **Done** | Prove CPU ↔ GPU parity across all domains | 2,097+ checks PASS |
...
|--------|-------|
| Experiments | 91 |
| Validation checks | 2,097+ (all PASS) |
| Rust tests | 728 (654 lib + 60 integration + 14 doc) |
| Binaries | 81 (73 validate + 8 benchmark) |
...
| Local WGSL shaders | 1 (ODE, blocked) |
| Tier A modules | 7 |
| Tier B modules | 2 |
