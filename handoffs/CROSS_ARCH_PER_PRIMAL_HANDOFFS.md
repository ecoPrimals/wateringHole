...
| toadStool | 4 | Small | **DONE** | `592248618`→`05d6476` S329-S334 full cfg + Phase 2 GPU + structural debt (−1,888L extracted) |
...
- toadStool: S329-S334 deep debt + Phase 2 GPU backends + structural debt (11 files extracted, −1,888L, 750L gate cleared, dispatch clone polish)
