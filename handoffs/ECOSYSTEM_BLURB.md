...
| **coralReef** | `3442282` | biomeGate | **G65 SHIPPED. C3 VERIFIED.** Protocol negotiation on UDS + 3 G65 E2E health.liveness integration tests (negotiate, backward-compat, tarpc-fallback). 3,689 tests. | **DONE** |
