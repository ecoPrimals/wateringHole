...
| barraCuda | CLEAN | PASS | PASS (4.4K) | n/a | All quality gates green; 4,393 tests; LD-05/LD-10 resolved |
| sourDough | CLEAN | PASS | PASS (239) | **C** | Missing `deny.toml`; musl/signing |
| coralReef | CLEAN | PASS | PASS (4.5K) | **C** | Iter 80 — 4,506 tests, wire contract documented, CompilationInfo IPC, BTSP Phase 2, deny.toml enforced, VFIO feature-gated, zero clippy/doc warnings |
