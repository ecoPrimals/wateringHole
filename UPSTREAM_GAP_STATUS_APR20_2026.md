...
| loamSpine | 0.9.16 | 1,502 pass | READY — BTSP Step 3→4 relay fixed (beardog_types aligned), NDJSON + provider socket wired, stadial gate cleared |
