...
- **Stadial gate cleared**: BearDog W56, Songbird W162, NestGate 43w, ToadStool S203t, petalTongue v1.6.7, sweetGrass stadial — zero async-trait, zero finite dyn, Edition 2024
...
| **RESOLVED** | Songbird | 0 `#[async_trait]`, 0 finite `dyn`, 0 production mocks, 0 bare `#[allow]`, 0 blanket lint suppress, 0 hardcoded IPs/ports, 0 unused deps, 0 `Box<dyn Error>` in production. W160: BTSP NDJSON auto-detect (Phase 45c). W161: port centralization, dep cleanup, error typing. W162: `stream.shutdown()` removed from `SecurityRpcClient` — write-half FIN was killing BearDog BTSP roundtrip — Wave 162, 7,387+ tests, 0 failures |
