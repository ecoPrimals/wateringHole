...
| **healthSpring** | V65a | **5** | 1,052+ | **Nest** (neutron-heavy) + Meta | `healthspring_cell.toml` (plasmidBin) | **Active** — ironGate eukaryotic, 13/13 NUCLEUS, 59 scenarios, 88 capabilities, Wave 60 stabilization |
