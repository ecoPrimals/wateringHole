...
| **healthSpring** | V65a | **5** | 1,021+ | **Nest** (neutron-heavy) + Meta | `healthspring_cell.toml` (plasmidBin) | **Active** — ironGate eukaryotic, Forgejo sync + cascade-pull 22-repo, 13/13 NUCLEUS, 57 scenarios, 88 capabilities, Wave 60 |
