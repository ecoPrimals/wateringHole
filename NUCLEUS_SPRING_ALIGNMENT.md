...
| **healthSpring** | V65b | **5** | 1,056+ | **Nest** (neutron-heavy) + Meta | `healthspring_cell.toml` (plasmidBin) | **Active** — ironGate eukaryotic, 13/13 NUCLEUS, 59 scenarios, 88 capabilities, Wave 63 temporal sync, BTSP probe, domain_profile.toml |
