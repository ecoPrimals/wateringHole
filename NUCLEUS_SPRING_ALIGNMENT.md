...
| **healthSpring** | V65a | **5** | 1,021+ | **Nest** (neutron-heavy) + Meta | `healthspring_cell.toml` (plasmidBin) | **Active** — Post-primordial, ironGate operational, 57 scenarios, 88 capabilities, Wave 49 clean |
