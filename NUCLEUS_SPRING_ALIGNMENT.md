...
**Date**: May 13, 2026
**From**: primalSpring v0.9.25 (Phase 58+ — Post-Full-Pull Audit, 445 methods)
...
| **healthSpring** | V65a | **5** | 1,021+ | **Nest** (neutron-heavy) + Meta | `healthspring_cell.toml` (plasmidBin) | **Active** — Post-primordial, ironGate operational, 57 scenarios, 88 capabilities, Wave 50 covalent HPC, dual-tower + Nest Atomic validated |
...
6. **neuralSpring** (5) — `src/ipc/` tree complete (7 modules), CapabilityRouter discovery (37 capabilities, 20 hints), NestGate weight persistence wired, Squirrel inference pipeline complete, Tier 2 COMPLETE, deep debt zero-debt (4 audits, V158, 910 tests)
