...
| ludoSpring | V46 | 790+ | **4** | Composing; 100 experiments; `ludospring_guidestone` three-tier (readiness 4: 20 bare + 15 IPC + 8 NUCLEUS cross-atomic). BLAKE3 P3, protocol tolerance; plasmidBin v0.10.0 |
